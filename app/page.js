    ...
    <div>
      ...
      <section className="hero min-h-screen bg-linear-to-r from-green-400 via-emerald-500 to-teal-600 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-20">
          ...
          <div className="absolute top-40 right-20 text-5xl animate-pulse">
            🍃
          </div>
          <div className="absolute bottom-40 left-1/4 text-4xl animate-bounce delay-100">
            🌱
          </div>
          <div className="absolute bottom-20 right-1/3 text-5xl animate-pulse delay-200">
            🌾
          </div>
        </div>
        ...
        <div className="hero-content text-center text-white relative z-10 px-4">
          <div className="max-w-3xl">
            ...
            <p className="text-xl md:text-3xl mb-2 font-light">
              Nourish Your Body, Nurture the Planet
            </p>
            <p className="text-base md:text-xl mb-8 opacity-90 max-w-2xl mx-auto px-4">
              Discover premium plant-based wellness products that are good for
              you and the Earth
            </p>
            <div className="flex gap-4 justify-center flex-wrap px-4">
              <Link
                href="/items"
                className="btn btn-accent btn-lg gap-2 hover:scale-105 transition-transform"
              >
                🛍️ Shop Now
              </Link>
              <a
                href="#mission"
                className="btn btn-outline btn-lg text-white border-white hover:bg-white hover:text-green-600 hover:scale-105 transition-transform"
              >
                Learn More
              </a>
            </div>
            <div className="flex gap-3 justify-center mt-8 flex-wrap px-4">
              <div className="badge badge-lg bg-white/20 text-white border-white/30 backdrop-blur-sm px-4 py-3">
                ✓ 100% Organic
              </div>
              <div className="badge badge-lg bg-white/20 text-white border-white/30 backdrop-blur-sm px-4 py-3">
                ✓ Eco-Friendly
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: "100% Organic",
                desc: "All products are certified organic and sustainably sourced from trusted farmers",
                icon: "🌱",
              },
              {
                title: "Eco-Friendly",
                desc: "Zero-waste packaging and carbon-neutral shipping on every order",
                icon: "♻️",
              },
              {
                title: "Wellness First",
                desc: "Science-backed products formulated for optimal health and vitality",
                icon: "💚",
              },
            ].map((feature, idx) => (
              <motion.div
            ...
            {[
              {
                name: "Maya Johnson",
                review:
                  "The moringa powder has transformed my morning routine! I feel more energized and healthy.",
                rating: 5,
              ...
              },
              {
                name: "David Chen",
                review:
                  "Love the eco-friendly packaging and quality products. Finally a store that cares!",
                rating: 5,
              ...
              },
              {
                name: "Aisha Patel",
                review:
                  "The herbal tea collection is amazing. Perfect for my evening relaxation ritual.",
                rating: 5,
                product: "Herbal Tea Box",
                avatar: "👩‍🦱",
              },
            ].map((testimonial, idx) => (
              <motion.div
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Get exclusive deals, wellness tips, and sustainable living guides
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-6">
                Our Planet Commitment
              </h2>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                For every order placed, we plant a tree through our partnership
                with environmental organizations. We're committed to
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto">
              Join thousands who've made the switch to sustainable, plant-based
              living
            </p>
            <Link
              href="/items"
              className="btn btn-accent btn-lg gap-2 hover:scale-110 transition-transform"
            >
              Explore Products 🌿
            </Link>
          </motion.div>
