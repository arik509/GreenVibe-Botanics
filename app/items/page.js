...
export default function ItemsPage() {
  ...
  return (
    <div className="min-h-screen bg-base-100">
      {/* Hero Section */}
      <div className="hero bg-linear-to-r from-green-400 to-emerald-600 text-white py-20">
        <div className="hero-content text-center">
          <div className="max-w-3xl">
            ...
            <p className="text-xl md:text-2xl mb-6">
              Discover our curated collection of organic, plant-based wellness
              essentials
            </p>
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-12">
          ...
          {categories.map((cat) => (
            <motion.button
              ...
              className={`btn ${
                selectedCategory === cat.name ? "btn-primary" : "btn-outline"
              }`}
            >
              {cat.icon} {cat.name}
            </motion.button>
